...
也可对 D 杆质心列力矩方程，结果等价。其实这个题目做到这里就可以准备跑路了，下一道题的数值结果的正确与否完全取决于你这道题的方程的正确性。如果没什么太大把握其实不是很建议继续往下算。当然是对于和我一样的一般选手，如果你有足够的时间这个题还是可以做一做。
